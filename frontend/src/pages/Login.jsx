...
export const Login = () => {
  ...
  return (
    <>
      ...
      <form onSubmit={onSubmintHandeler} className="min-h-[80vh] flex items-center">
        ...
        <div className="flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600  text-sm shadow-lg">
...

          {
            ...
            </p> : <p>Create an new account?  <span onClick={() => setState('Sign Up')} className="text-primary underline cursor-pointer">Click Hare</span>   </p>
          }
