...
export const Myprofile = () => {
  ...
  const updateUserProfileData = async () => {
    ...
    try {
      ...
      formData.append('phone', userData.phone)/*x*/
  ...
  return userData && (
    <div className="max-w-lg flex flex-col gap-2 text-sm ">
      ...
      {
        isEdite ? <input className="bg-gray-50 text-3xl font-medium max-w-60 mt-4 " type="text" value={userData.name} onChange={e => setUserData(prev => ({ ...prev, name: e.target.value }))} /> : <p className="font-medium text-3xl text-neutral-800  mt-4  ">{userData.name}</p>
      }
      ...
      <div className="">
        ...
        <div className="grid grid-cols-[1fr_3fr]  gap-y-2.5 mt-3 text-neutral-700  ">
          ...
          {
            isEdite ? <input className="bg-gray-100  max-w-52 " type="text" value={userData.phone} onChange={e => setUserData(prev => ({ ...prev, phone: e.target.value }))} /> : <p className="text-blue-400"  >{userData.phone}</p>
          }
      ...
      <div className="">
        ...
        <div className=" grid grid-cols-[1fr_3fr] gap-y-2.5 text-neutral-700 mt-3">
          ...
          {
            isEdite ? <select className="max-w-20 bg-gray-100" onChange={(e) => setUserData(prev => ({ ...prev, gender: e.target.value }))} value={userData.gender}  >
